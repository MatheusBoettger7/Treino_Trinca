const CACHE='treino-trinca-v18';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./css/app.css','./js/app.js','./js/mobile-fix.js','./js/editor-v16.js','./js/repdb.js','./data/workouts.json'];
